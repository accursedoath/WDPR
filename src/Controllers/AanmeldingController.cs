...
namespace src.Controllers
{
    public class AanmeldingController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AanmeldingId,Voornaam,Achternaam,BSN,Email,Stoornis,Leeftijdscategorie,NaamVoogd,EmailVoogd,TelefoonVoogd,Hulpverlener,AfspraakDatum")] Aanmelding aanmelding, string Hulpverlener)
        {
            ViewData["Hulpverlener"] = await _context.Hulpverleners.ToListAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AanmeldingId,Voornaam,Achternaam,BSN,Email,Stoornis,Leeftijdscategorie,NaamVoogd,EmailVoogd,TelefoonVoogd,Hulpverlener,AfspraakDatum")] Aanmelding aanmelding, string Hulpverlener)
        {
