        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Hulpverlener = table.Column<int>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Aanmeldingen", x => x.AanmeldingId);
                    table.ForeignKey(
                        name: "FK_Aanmeldingen_Account_Hulpverlener",
                        column: x => x.Hulpverlener,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Aanmeldingen_Hulpverlener",
                table: "Aanmeldingen",
                column: "Hulpverlener");
